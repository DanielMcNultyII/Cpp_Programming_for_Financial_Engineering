...
void Option::Copy(const Option& source)		// Copy all values
{
...
// Constructors
Option::Option() : optionType(Call) {}											// Default constructor

Option::Option(const Option& source) : optionType(source.optionType) {}			// Copy constructor
